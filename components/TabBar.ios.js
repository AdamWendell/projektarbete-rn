  ...
  render: function() {
    return (
      <TabBarIOS
        ...
        <TabBarIOS.Item
          title="Meny"
          badge={this.props.drawer ? 'close' : 'open'}
        ...
        <TabBarIOS.Item
          ...
          <View style={{flex:1, backgroundColor: 'white'}}><StatusBar hidden={true}/><Content /></View>
        </TabBarIOS.Item>
        <TabBarIOS.Item
          systemIcon="more"
          title="More"
...
module.exports = connect(mapStateToProps, mapDispatchToProps)(TabBarExample);